        ...
        if (LATC5) {
            if (T0_int2(50)) {
                if (dgm_f) {
                    ...
                    else if (cnt < ((3.5 * 100) / 5 + (100 - (3.5 * 100) / 5) / 5 * 1)) {
                        val = 5;
                    }
                    else if (cnt < ((3.5 * 100) / 5 + (100 - (3.5 * 100) / 5) / 5 * 2)) {
                        val = 4;
                    }
                    else if (cnt < ((3.5 * 100) / 5 + (100 - (3.5 * 100) / 5) / 5 * 3)) {
                        val = 3;
                    }
                    else if (cnt < ((3.5 * 100) / 5 + (100 - (3.5 * 100) / 5) / 5 * 4)) {
                        val = 2;
                    }
                    else if (cnt < ((3.5 * 100) / 5 + (100 - (3.5 * 100) / 5) / 5 * 5)) {
                        val = 1;
                    }
                    else {
                        val = 0;
